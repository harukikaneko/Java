    ...
    <main>
      ...
      <form action="./ResultServlet" method="post">
        ...
        <div class="button">
          <input
            class="common_button"
            　onclick="return notice()"
            type="submit"
            value="売却する"
          />
          <input type="hidden" name="code"
          value="<%=request.getAttribute("code") %>"/> <input type="hidden"
          name="name" value="<%=request.getAttribute("name") %>"/> <input
          type="hidden" name="quantity"
          value="<%=request.getAttribute("quantity") %>"/> <input type="hidden"
          name="purchased_total"
          value="<%=request.getAttribute("purchased_total")%>"/> <input
          type="hidden" name="select" value="<%=request.getAttribute("select")
          %>"/> <input type="hidden" name="choice"
          value="<%=request.getAttribute("choice") %>"/> <input type="hidden"
          name="dateinfo" value="<%= session.getAttribute("dateinfo") %>"/>
          <input type="hidden" name="date" value="<%=
          session.getAttribute("date") %>"/>
          <input type="hidden" name="orderstatus" value="注文中" />
          <input type="hidden" name="sellbuy" value="売り" />
        </div>
        <input
          class="common_button"
          type="submit"
