		...
		<form action="orderServlet">
			...
			<div>
				...
				<tr>
					...
					<input class="common_button" type="submit" value="注文"> <input type="hidden" name="code" value="<%=bean.getItemCode()%>" />
					<%
				}
			%>
			</div>
				...
				<tbody>
					...
					%>
						<tr>
							<%-- 一週間分の株価 --%>
							<td><span>
									<%=bean.getOneDayAgo()%></span></td>
							<td><span>
									<%=bean.getTwoDaysAgo()%></span></td>
							<td><span>
									<%=bean.getThreeDaysAgo()%></span></td>
							<td><span>
									<%=bean.getFourDaysAgo()%></span></td>
							<td><span>
									<%=bean.getFiveDaysAgo()%></span></td>
							<td><span>
									<%=bean.getSixDaysAgo()%></span></td>
							<td><span>
									<%=bean.getSevenDaysAgo()%></span></td>
						</tr>
						<%
						}
					%>
