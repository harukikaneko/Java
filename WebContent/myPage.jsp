...
<% if (session == null) { session.setMaxInactiveInterval(600); } %> <% if
(session.isNew()) { response.sendRedirect(request.getContextPath() +
"/loginFailed.jsp"); return; } %>
<html>
  <head>
  ...
  <body>
    ...
    <div class="my">
      ...
      <p class="my">
        ...
        <a class="common_button" href="HistoryServlet?submit=history"
          >購入履歴</a
        >&emsp;
        <a class="common_button" href="favlistServlet?submit=fav">お気に入</a
        ><br />
      </p>
    </div>
  </body>
